...
import { esc, on, fmtTime, f0, f1, f2, words, infoBtn, infoNote } from '../ui.js';
  ...
  const render = () => {
    ...
    root.innerHTML = `<div class="page three">
      ...
      <aside class="col">
        ...
        ${fit ? '<button class="btn" data-refit>Refit</button>' : ''}<a href="#/recipe-search" class="btn dark">Re-run the recipe search</a>
      </aside>
    </div>`;
  };
